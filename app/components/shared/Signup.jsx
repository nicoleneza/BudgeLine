...
const Signup = () => {
  ...
  <input type="submit"  class="mt-5 px-3 py-2 bg-blue-500 border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-full sm:text-sm focus:ring-1 font-bold text-white"/>
</label>
</form>
        <div className='flex flex-col'>
